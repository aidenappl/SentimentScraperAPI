...
func buildPrompt(article structs.News) string {
	return fmt.Sprintf(`
You are a sentiment analysis engine, you only respond in the given JSON structure. Use VADER, TextBlob or general analysis to determine your results. Given this article data, extract the following fields:
- sentiment_summary (concise overview of sentiment and why)
- score (range: -1 to 1)
- positive, negative, neutral (range: 0 to 1)
